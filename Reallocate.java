...
public class Reallocate extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("There are "+(int)shortTermStaff+" short term employees");
			out.println("There are "+(int)mediumTermStaff+" medium term employees");
			out.println("There are "+(int)longTermStaff+" long term employees");
			out.println("");
			out.println("");
