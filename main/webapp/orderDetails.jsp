...
<%
    ...
    String sql2="SELECT * FROM orders where customerId=7";
    ...
    String sql1="SELECT * FROM orders where  orderId="+request.getParameter("orderId") +"and customerEmail='"+request.getParameter("email")+"'";
...
%>                        
                        <tr>
                            ...
                            <td>
                                <div style="margin-top: 1px;"><img src="Assets/images/products/bed1.jpeg" alt="alt" style="object-fit: contain" width="150px" height="150px" /></div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div ><%=result.getString("Quantity")%></div>
                            </td>
                            <td>
                                <div >UGX 200000</div>
                            </td>`
                            ...
                            <td>
                                <div ><%=result.getString("paymentMethod")%></div>
                            </td>
                            <td>
                                <div ><%=result.getString("orderDate")%></div>
                            </td>
                            <td>
