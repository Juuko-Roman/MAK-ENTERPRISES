...
<header>
        <div class="top-header">
            <div class="left-content">
                <a href="http://localhost:8080/MAK_ENTERPRISES/customer/my-cart.jsp">| &nbsp <i class="icon fa fa-user"></i> My Account &nbsp &nbsp</a>
                <a href="http://localhost:8080/MAK_ENTERPRISES/customer/my-wishlist.jsp">| &nbsp <i class="icon fa fa-heart"></i>  Wish list &nbsp &nbsp </a>
                <a href="http://localhost:8080/MAK_ENTERPRISES/customer/my-cart.jsp">| &nbsp  <i class="icon fa fa-shopping-cart"></i> My Cart &nbsp &nbsp</a>
                <a href="http://localhost:8080/MAK_ENTERPRISES/customer/login.jsp">| &nbsp <i class="icon fa fa-sign-in"></i> Login |</a>
            </div>
