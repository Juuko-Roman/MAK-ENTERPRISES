...
%>
            ...
            <div class="product">
                <div class="image"> <a href="customer/product-details.jsp?id=<%=result.getInt("id")%>"><img src="customer/Assets/images/products/<%=result.getString("productImage1")%>" width="100%" height="100%"/></a></div>
                <div class="image-footer">
                    ...
                    <div class="likes" >
                        <i class="liked fa fa-thumbs-o-up " style="font-size: 20px" data-value="<%=result.getString("id")%>" ></i>
                        <span style="font-size: 20px" class="likesCount"> <%=result.getString("likes")%>  likes</span>                            
                                                &nbsp; &nbsp;
