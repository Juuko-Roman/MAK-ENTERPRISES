        ...
        <div class="" style=" height: 650px">
            <div style="height: 100%; width: 80%;  margin-left: 150px">
                ...
                <div style="height: 100%; width: 45%;  margin-left: 30px; float: left">
                    <h2 style="font-size: 40px;">Shipping Details</h2>
                ...
                <div style="height: 100%; width: 45%;  margin-left: 30px; float: left">
                    <h2 style="font-size: 40px;">Billing Details</h2>
                    <div class="login-details" style="width: 100%;height: 550px">
                        ...
                        <div style="width: 100%;height: 60px ">
                            <button type="submit" style="background-color: #55f;width: 30%;height: 60px; margin-top: 10px; border-radius: 20px; color: white"><b>Finish</b></button>
                        </div>
                    </div>
                    </form>
                </div>                
